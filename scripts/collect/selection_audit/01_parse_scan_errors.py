...
def main():
    ...
    # The .tex this used to write is generated by build_scan_failure_reasons()
    # in scripts/R/10_validity.R. This script's live output is the CSV above,
    # which is also the sampling frame the selection audit was drawn from.
